...
На данный момент доступные отправщик: console, zabbix, prometheus, prometheus_push
* console не имеет настроек
* заббикс имеет следующие настройки
...
* prometheus имеет настройки:
  * addr - в формате golang: ":9000", "127.0.0.1:9000"
* prometheus_push имеет настройки:
  * url - адресс push gateway: "http://127.0.0.1:1234"
  * job - название job, которая будет в лейблах на всех метриках
...
**Список доступных групповых операци (prometheus):**
